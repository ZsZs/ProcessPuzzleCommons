 ...
 * http://www.javaworld.com/javaworld/javaqa/2003-07/01-qa-0711-classsrc.html also thrown in for a good measure. See
...
public abstract class ClassScope // this class is not instantiable
{
   ...
   /**
    * Returns the class loader set "relevant" to the calling class, as described in the article. Starting with the class
    * that is the caller of this method, it collects all class loaders that are loaders for all classes on the call
    * stack and their respective parent loaders.
    * 
